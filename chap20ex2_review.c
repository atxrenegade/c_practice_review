...
Chapter 20 ex2 page 188
chap20ex2_review.c
This program rolls two dice and and presents the total.  
It then asks the user to guess if the neext total will 
be higher, lower, or equal. It then rolls two more dice 
and tells the user how they did.*/
...
int main (void)
{
    ...
    // This would giv e you a number between 0 and %, so the + 1
    // makes it 1 to 6
    ...
    if (ans == 'L')
    {
        ...
        {
            printf("Sorry! %d in not lower than %d\n\n", total2, total1);
        }
    }  
    else if (ans == 'H')
    {
