...
Chapter 32 ex1 page 307
chap32ex1_review.c

This program demonstrates functions returning a value by passing
...
int main(void)
{
	...
	printf("What was the grade on the secong test? ");
	scanf(" %f", &grade2);
...
// Receives the value of three grades
{
	float localAverage = (test1 + test2 + test3)/3;
